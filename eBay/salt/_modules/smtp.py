...
def send_msg(recipient,
    ...
    Added payload argument for (eb) LUKS email support
    ...
    # Show payload argument
    # Used by luks_email.py module
    log.info("--->> smtp.send_psg payload: " + str(payload))
    ...
    # ADD CC
    cc = 'amalaguti@saltstack.com'
    cc_recipient = [cc]
    msg['Cc'] = cc
    recipients = recipient + ',' + cc
    log.info("Recipients: " + str(recipients))
    recipients = [r.strip() for r in recipients.split(',')]
    log.info("Sending email to: " + str(recipients))
